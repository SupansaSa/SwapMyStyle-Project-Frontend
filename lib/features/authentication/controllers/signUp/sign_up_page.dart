...
import 'package:myapp/features/authentication/controllers/TermsAndConditions/privacy_policy_page.dart';
import 'package:myapp/features/authentication/controllers/signIn/sign_in_page.dart';
import 'package:myapp/widgets/custom_text_field.dart';
import 'package:myapp/widgets/custom_button.dart';
import 'package:myapp/features/authentication/controllers/TermsAndConditions/terms_and_conditions_page.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<void> registerUser(
    ...
    final url = Uri.parse('http://192.168.31.218:3000/register');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          padding: const EdgeInsets.symmetric(horizontal: SignUpPage.defaultMargin),
          child: Column(
            ...
            children: [
              ...
              CustomTextField(
                ...
                hintText: 'Type your Identification Number...',
                textEditingController: _citizenIdController,
                ...
                child: CustomButton(
                  ...
                  onPressed: (BuildContext context) {
                    if (_usernameController.text.isEmpty ||
                      ...
                      _showErrorDialog('กรุณากรอกข้อมูลให้ครบทุกช่องและกดยอมรับเงื่อนไขการให้บริการและนโยบายความเป็นส่วนตัว');
                      return;
                    }
                    registerUser(
