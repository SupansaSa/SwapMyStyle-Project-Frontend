...
class _AddHomePageState extends State<AddHomePage> {
  ...
  Future<void> _loadItems() async {
    ...
    final response = await http.get(Uri.parse('http://192.168.1.54:3000/getItems?userId=$userId'));
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => ItemDetailPage(
                              item: item,
                              currentUserId: userId!, // ส่ง userId ที่โหลดได้
                            ),
                          ),
                        );
                      },
                          ...
                          child: Column(
                            ...
                            children: [
                              if (item['item_photo'] != null)
                                Expanded( // ใช้ Expanded เพื่อให้แน่ใจว่า Column ปรับขนาดตามพื้นที่ที่มีอยู่
                                  child: Container(
