...
class _AddItemPageState extends State<AddItemPage> {
  ...
  Future<void> addItem() async {
    ...
    final url = Uri.parse('http://192.168.31.218:3000/addItem');
            ...
            children: [
                          ...
                          children: [
                            Center(
                              child: Column(
                                ...
                                children: [
                                  Icon(Icons.camera_alt_outlined, size: 50, color: Colors.pink),
                                  SizedBox(height: 10),
                                  Text(
                                    '+ เพิ่มรูปภาพ',
                                    style: TextStyle(
              ...
              CustomTextField(
                ...
                suffixIcon: DropdownButton<String>(
                  value: _itemTypeController.text.isNotEmpty ? _itemTypeController.text : null,
                  onChanged: (newValue) {
                    setState(() {
                      _itemTypeController.text = newValue!;
                    });
                  },
                  items: ['เสื้อ', 'กางเกง', 'เดรส', 'เครื่องประดับ', 'กระเป๋า', 'รองเท้า'].map((String value) {
